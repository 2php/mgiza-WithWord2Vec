...
public:
  ...
  int em_with_tricks(int noIterations,
                     bool seedModel1, Dictionary& dictionary, bool useDict, Word2Vec &word2vec, bool useWord2Vec, bool dumpCount = false,
                     const char* dumpCountName = NULL, bool useString = false);
  int em_thread(int noIterations, int thread, Dictionary& dictionary, bool useDict, Word2Vec &word2vec, bool useWord2Vec);
...
////////////////////////////////////////////////////////////////
private:
  void em_loop(int it, Perplexity& perp, sentenceHandler& sHandler1, bool seedModel1, bool , const char*, Dictionary& dictionary, bool useDict, Word2Vec &word2vec, bool useWord2Vec,
